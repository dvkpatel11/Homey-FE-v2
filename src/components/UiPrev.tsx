...
const UIPreview: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen ${isDark ? "dark" : ""} bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900...`}
    >
      <UI.GlassButton onClick={() => setIsDark(!isDark)} className="fixed top-4 right-4 z-50">
        {isDark ? "☀️" : "🌙"}
      </UI.GlassButton>
      ...
      <main className="relative z-10 p-6 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <UI.GlassHeading
            level={1}
            className="text-4xl font-bold bg-gradient-to-r from-white to-violet-200 bg-clip-text text-transparent mb-4"
          >
            UI Components Library
          </UI.GlassHeading>
          <UI.GlassText variant="secondary">Explore all the beautiful glassmorphic components</UI.GlassText>
        </div>
          ...
          <UI.GlassSection title="Typography" subtitle="Headings and text components">
            <UI.GlassContainer padding="md">
              <div className="space-y-4">
                <UI.GlassHeading level={1}>Heading 1</UI.GlassHeading>
                <UI.GlassHeading level={2}>Heading 2</UI.GlassHeading>
                <UI.GlassHeading level={3}>Heading 3</UI.GlassHeading>
                <UI.GlassHeading level={4}>Heading 4</UI.GlassHeading>
                <UI.GlassText variant="default">Default text with glass styling</UI.GlassText>
                <UI.GlassText variant="secondary">Secondary text variant</UI.GlassText>
                <UI.GlassText variant="muted">Muted text for subtle content</UI.GlassText>
              </div>
            </UI.GlassContainer>
          </UI.GlassSection>
            ...
            <UI.GlassContainer padding="md">
              <div className="space-y-4">
                <div className="flex flex-wrap gap-3">
                  ...
                  <UI.GlassButton variant="secondary" icon={User}>
                    Secondary
                  </UI.GlassButton>
                  <UI.GlassButton variant="ghost" icon={Settings}>
                    Ghost
                  </UI.GlassButton>
                  <UI.GlassButton variant="danger" icon={Mail}>
                    Danger
                  </UI.GlassButton>
                </div>
          ...
          <UI.GlassSection title="Cards & Containers" subtitle="Different card variants and containers">
            <div className="space-y-4">
              <UI.GlassCard variant="default" className="p-4">
                <UI.GlassText>Default glass card with hover effects</UI.GlassText>
              </UI.GlassCard>

              <UI.GlassCard variant="subtle" className="p-4">
                <UI.GlassText>Subtle glass card variant</UI.GlassText>
              </UI.GlassCard>

              <UI.GlassCard variant="strong" className="p-4">
                <UI.GlassText>Strong glass card variant</UI.GlassText>
              </UI.GlassCard>

              <UI.GlassCard variant="violet" className="p-4">
                <UI.GlassText>Violet-themed glass card</UI.GlassText>
              </UI.GlassCard>

              <UI.GlassContainer variant="violet" padding="lg">
                <UI.GlassText>Container with violet variant and large padding</UI.GlassText>
              </UI.GlassContainer>
            </div>
          </UI.GlassSection>
            ...
            <UI.GlassContainer padding="md">
              <div className="space-y-4">
                ...
                <div className="flex gap-4 items-center">
                  <UI.GlassText variant="muted">Icon Buttons:</UI.GlassText>
        ...
        <UI.GlassModal isOpen={modalOpen} onClose={() => setModalOpen(false)} title="Example Modal" maxWidth="md">
          <div className="space-y-4">
            ...
            <div className="flex gap-3 justify-end pt-4">
              <UI.GlassButton variant="ghost" onClick={() => setModalOpen(false)}>
                Cancel
              </UI.GlassButton>
              <UI.GlassButton onClick={() => setModalOpen(false)}>Confirm</UI.GlassButton>
            </div>
          </div>
        </UI.GlassModal>
